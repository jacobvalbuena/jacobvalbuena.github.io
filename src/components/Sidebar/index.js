...
import { faEnvelope, faEye, faHandshake, faHome, faLaptop, faUser } from '@fortawesome/free-solid-svg-icons'
import { faGithub, faLinkedin } from '@fortawesome/free-brands-svg-icons'

const Sidebar = () => (
    <div className = "nav-bar">
        <Link className = "logo" to = "/">
            <img src = {j3logo} alt = "logo" />
            {/* <img className = "sub-logo" src = {jlogo} alt = "slobodan"/> */}   
        </Link>
        <nav>
        ...
        <ul>
            <li>
                ...
                target="_blank" 
                rel='noreferrer' 
                href="https://www.linkedin.com/in/jacob-valbuena-a09a49212/"
                >
            ...
            <li>
                ...
                target="_blank" 
                rel='noreferrer' 
                href="https://app.joinhandshake.com/stu/users/33473070"
                >
